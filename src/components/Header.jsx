...
function Header({children}) {
  return (
    <div className='flex flex-row gap-10 bg-darkColdBlue-600 w-full h-20 fixed  text-xl font-medium items-center justify-between px-40 py-8 border-b-2 border-darkColdBlue-400 z-50'>
