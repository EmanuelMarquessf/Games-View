...
function Header({ children }) {
  return (
    <div className="flex flex-col md:flex-row gap-10 bg-darkColdBlue-600 w-full py-4 text-xl font-medium items-center justify-between md:px-20 xl:px-48 border-b-2 border-darkColdBlue-400 z-50">
